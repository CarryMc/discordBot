...
class commandRandomExampleImage extends COMMANDO.Command {
    constructor(BOT_COMMANDO) {
        super(BOT_COMMANDO,
            //command initializing
            {
                ...
                description: 'randomimage example',
    ...
    run(message) {
        ...
        var filePost = ({ files: [exampleArrayImages[Math.floor(Math.random() * exampleArrayImages.length)]]});
...
module.exports = commandRandomExampleImage; 